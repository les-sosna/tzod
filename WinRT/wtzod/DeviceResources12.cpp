...
IRender& DeviceResources12::GetRender(int rotationAngle, int width, int height)
{
...
HRESULT DeviceResources12::ResizeSwapChainInternal(int width, int height, int rotationAngle)
{
