...
},
{
   ...
   content={
     indicator_health={left=0, top=6, right=48, bottom=11, xpivot=0, ypivot=0},
...
},
{
   ...
   content={
     ...
     ctrl_scroll_vert={left=0, right=48, top=156, bottom=180, xframes=4, yframes=1, xpivot=0, ypivot=0},
     ctrl_scroll_down={left=0, right=48, top=180, bottom=192, xframes=4, yframes=1, xpivot=0, ypivot=0},
     ctrl_scroll_left={left=96, right=108, top=144, bottom=192, xframes=1, yframes=4, xpivot=0, ypivot=0},
     ctrl_scroll_hor={left=108, right=132, top=144, bottom=192, xframes=1, yframes=4, xpivot=0, ypivot=0},
     ctrl_scroll_right={left=132, right=144, top=144, bottom=192, xframes=1, yframes=4, xpivot=0, ypivot=0},
     ctrl_list={left=66, right=94, top=194, bottom=222, xframes=1, yframes=1, xpivot=0, ypivot=0},
