...
REFLECTION_BEGIN(LangCache)
	...
	VAR_STR( obj_service_menu, "Service: Campign menu" )
	...
	VAR_STR( unlimmap_mode, "Unlimited map mode" )
	...
	VAR_STR( bot_level, "Experience" )
	VAR_STR( bot_level_0, "Looser" )
	VAR_STR( bot_level_1, "Normal" )
	VAR_STR( bot_level_2, "Advanced" )
	VAR_STR( bot_level_3, "Hardcore" )
	VAR_STR( bot_level_4, "Nightmare" )
...
//	VAR_STR( net_connect_loading_map_x, "Loading map '%s'..." )
	...
	VAR_STR( settings_show_particles, "Show particles" )
	VAR_STR( settings_show_damage, "Show damage" )
