...
#define TOWER_ROT_SPEED      3.5f   // максимальная скорость
#define TOWER_ROT_ACCEL     10.5f   // ускорение
...
#define TXT_VERSION      "Танк: Зона смерти. Версия 1.41 alpha 4"
