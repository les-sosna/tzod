...
#define ED_MOVING_OBJECT(name, desc, layer, width, height, align, offset) \
	RTTypes::Inst().RegisterObject<__ThisClass>((name), (desc), (layer), (width), (height), (align), (offset))

#define ED_ITEM(name, desc, layer) ED_MOVING_OBJECT(name, desc, layer, 32 /*width*/, 32 /*height*/, WORLD_BLOCK_SIZE/2 /*align*/, 0 /*offset*/)
...
#define ED_TURRET(name, desc) \
	ED_MOVING_OBJECT(name, desc, 0 /*layer*/, WORLD_BLOCK_SIZE*2 /*width*/, WORLD_BLOCK_SIZE*2 /*height*/, WORLD_BLOCK_SIZE /*align*/, WORLD_BLOCK_SIZE /*offset*/)
