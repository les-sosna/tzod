...
},
{
   ...
   content={
     brick_wall={left=2*0, top=2*0, right=2*128, bottom=2*64, xframes=4, yframes=2},
     brick_lt={left=2*128, top=2*0, right=2*160, bottom=2*128, yframes=4},
     brick_rt={left=2*160, top=2*0, right=2*192, bottom=2*128, yframes=4},
     brick_rb={left=2*192, top=2*0, right=2*224, bottom=2*128, yframes=4},
     brick_lb={left=2*224, top=2*0, right=2*256, bottom=2*128, yframes=4},
     concrete_wall={left=2*0, top=2*64, right=2*32, bottom=2*96},
     concrete_wall1={left=2*32, top=2*64, right=2*64, bottom=2*96},
     concrete_wall2={left=2*64, top=2*64, right=2*96, bottom=2*96},
     concrete_wall3={left=2*96, top=2*64, right=2*128, bottom=2*96},
     concrete_lt={left=2*0,  top=2*96, right=2*32,  bottom=2*128},
     concrete_rt={left=2*32, top=2*96, right=2*64,  bottom=2*128},
     concrete_rb={left=2*64, top=2*96, right=2*96,  bottom=2*128},
     concrete_lb={left=2*96, top=2*96, right=2*128, bottom=2*128},
   }
},
{
...
},
{
   ...
   content={
     ...
     ["ui/scroll_up"]={left=0, right=48, top=144, bottom=156, xframes=4, yframes=1, xpivot=0, ypivot=0, border=2},
     ["ui/scroll_vert"]={left=0, right=48, top=156, bottom=180, xframes=4, yframes=1, xpivot=0, ypivot=0, border=2},
     ["ui/scroll_down"]={left=0, right=48, top=180, bottom=192, xframes=4, yframes=1, xpivot=0, ypivot=0, border=2},
     ["ui/scroll_left"]={left=128, right=140, top=64, bottom=112, xframes=1, yframes=4, xpivot=0, ypivot=0, border=2},
     ["ui/scroll_hor"]={left=140, right=164, top=64, bottom=112, xframes=1, yframes=4, xpivot=0, ypivot=0, border=2},
     ["ui/scroll_right"]={left=164, right=176, top=64, bottom=112, xframes=1, yframes=4, xpivot=0, ypivot=0, border=2},
     ...
     ["ui/pause"]={left=96, right=128, top=64, bottom=192, xpivot=0, ypivot=0, xframes=1, yframes=4},
     ...
     ["ui/star"]={left=32, top=208, right=128, bottom=256, xpivot=24, ypivot=24, xframes=2, yframes=1},
     ["ui/lock"]={left=128, top=128, right=256, bottom=256, xpivot=0, ypivot=0, xframes=1, yframes=1, xscale=0.5, yscale=0.5},
   }
},
{
